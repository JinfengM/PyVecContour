...
PyVecContour is used to plot contours by parsing data from EFDC's lxly.inp file and ee_wq.txt file.
It consists of the following general steps
1. parse the file
2. rotate to find the minimum area
3. kriging interpolation
4. calculating the contours
5. cropping the area
...
- [ ] [Set up project integrations](http://172.16.254.81:7781/gitlab/eps/efdc_contour/-/settings/integrations)
